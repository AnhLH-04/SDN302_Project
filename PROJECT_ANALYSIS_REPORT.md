...
| Theo dõi tin yêu thích | ⚠️ CÓ MODEL | `favoriteModel` có nhưng chưa thấy UI/Page |
| So sánh nhiều xe/pin | ❌ CHƯA CÓ | Không có chức năng compare |
...
| Gắn nhãn "đã kiểm định" | ❌ CHƯA CÓ | Không có field `verified` trong vehicle/battery |
| Quản lý giao dịch | ⚠️ CƠ BẢN | Có xem transactions nhưng chưa đầy đủ |
